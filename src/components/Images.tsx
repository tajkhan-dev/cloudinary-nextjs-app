...
})}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className={fav?`w-6 h-6 absolute cursor-pointer text-red-500`:'`w-6 h-6 absolute cursor-pointer'}>
